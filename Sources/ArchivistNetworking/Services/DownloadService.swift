...
public nonisolated protocol DownloadServiceType: Sendable {
    func getDownloads(config: ServerConfig, page: Int, filter: String?, channel: String?, query: String?, vidType: String?) async throws -> PaginatedResponse<DownloadResponse>
    func getDownload(config: ServerConfig, id: String) async throws -> DownloadResponse
    func addDownloads(config: ServerConfig, items: [AddDownloadItem]) async throws
    func updateDownloads(config: ServerConfig, videoIds: [String], status: String) async throws
    func deleteDownloads(config: ServerConfig, videoIds: [String]) async throws
    func updateDownload(config: ServerConfig, id: String, status: String) async throws
    func deleteDownload(config: ServerConfig, id: String) async throws
...
public nonisolated struct DownloadService: DownloadServiceType {
    ...
    public func getDownload(config: ServerConfig, id: String) async throws -> DownloadResponse {
    ...
    public func addDownloads(config: ServerConfig, items: [AddDownloadItem]) async throws {
    ...
    public func updateDownloads(config: ServerConfig, videoIds: [String], status: String) async throws {
    ...
    public func deleteDownloads(config: ServerConfig, videoIds: [String]) async throws {
    ...
    public func updateDownload(config: ServerConfig, id: String, status: String) async throws {
    ...
    public func deleteDownload(config: ServerConfig, id: String) async throws {
        let request = NetworkAPIRequest<EmptyResponse>(
            config: config,
            path: .download(id: id),
            method: .delete
