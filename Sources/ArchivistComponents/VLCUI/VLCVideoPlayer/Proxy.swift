...
public extension VLCVideoPlayer {
    ...
    class Proxy: ObservableObject {
        ...
        public func setSubtitleTrack(_ index: ValueSelector<Int>) {
            // No-op on this VLCKit build. The legacy
            // `currentVideoSubTitleIndex` setter was removed in favour of
            // the newer track-collection APIs, which our app doesn't use.
            _ = index
        }
        ...
        public func setAudioTrack(_ index: ValueSelector<Int>) {
            // No-op on this VLCKit build. See `setSubtitleTrack` above.
            _ = index
        }
